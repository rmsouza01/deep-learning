...
train_image_generator = train_image_datagen.flow_from_directory("/home/roberto.medeirosdeso/TALC-cluster-example/Data/Compressed/Train-root/",
                                                    class_mode=None, batch_size = 8,seed=seed, target_size=(288, 512),color_mode='rgb',shuffle = True)

train_target_generator = train_target_datagen.flow_from_directory("/home/roberto.medeirosdeso/TALC-cluster-example/Data/Uncompressed/Train-root/",
                                                    class_mode=None, batch_size = 8, seed=seed, target_size=(288, 512),color_mode='rgb' ,shuffle = True)
...
val_image_generator = val_image_datagen.flow_from_directory("/home/roberto.medeirosdeso/TALC-cluster-example/Data/Compressed/Val-root/",
                                                     class_mode=None, batch_size = 2,seed=seed, target_size=(288, 512),color_mode='rgb',shuffle = True)

val_target_generator = val_target_datagen.flow_from_directory("/home/roberto.medeirosdeso/TALC-cluster-example/Data/Uncompressed/Val-root/",
                                                    class_mode=None, batch_size = 2, seed=seed, target_size=(288, 512),color_mode='rgb' ,shuffle = True)
...
model_name = "/home/roberto.medeirosdeso/TALC-cluster-example/unet_jpeg.h5"
...
test_compressed = np.array(glob.glob("/home/roberto.medeirosdeso/TALC-cluster-example/Data/Compressed/Test-root/Test/*.jpg"))
test_uncompressed = np.array(glob.glob("/home/roberto.medeirosdeso/TALC-cluster-example/Data/Uncompressed/Test-root/Test/*.png"))
